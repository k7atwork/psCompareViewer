...
if ((!_IS_IE11) && (_SARISSA_IS_MOZ || _IS_CHROME))
{
    /**
...
else if ((!_IS_CHROME) && ((_IS_IE11) || (_SARISSA_IS_IE) || (_SARISSA_IS_IE9)))
{
     ...
     */
    XSLTProcessorIE.prototype.importStylesheet = function(xslDoc)
    {
     ...
     */
    XSLTProcessorIE.prototype.transformToDocument = function(sourceDoc)
    {
     ...
     */
    XSLTProcessorIE.prototype.setParameter = function(nsURI, name, value)
    {
     ...
     */
    XSLTProcessorIE.prototype.getParameter = function(nsURI, name)
    {
